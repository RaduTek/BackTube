...
def _parse_comment_renderer(
    ...
    *,
    ...
    comment: WatchPageComment = {
        ...
        'author_name': get_text(comment_renderer.get('authorText')),
        ...
        'like_count': get_text(comment_renderer.get('voteCount', {})),
...
def _parse_comment_view_model(
    ...
    comment: WatchPageComment = {
        ...
        'like_count': toolbar.get('likeCountNotliked', '') or toolbar.get('likeCountLiked', ''),
